...
void ofApp::setupGui() {
  ...
  thresholdGroupGui.add(antPhaseDiff0.setup(" PhaseDiff 0.5λ EAST-WEST (deg)", Const::getInstance().antPhaseDiff[0], 0, 360));
  antPhaseDiff0.addListener(this, &ofApp::onGuiChangeAntPhaseDiff0);

  thresholdGroupGui.add(antPhaseDiff1.setup(" PhaseDiff 0.5λ SOUTH-NORTH (deg)", Const::getInstance().antPhaseDiff[1], 0, 360));
  antPhaseDiff1.addListener(this, &ofApp::onGuiChangeAntPhaseDiff1);

  thresholdGroupGui.add(antPhaseDiff2.setup(" PhaseDiff 2.5λ EAST-WEST (deg)", Const::getInstance().antPhaseDiff[2], 0, 360));
  antPhaseDiff2.addListener(this, &ofApp::onGuiChangeAntPhaseDiff2);

  thresholdGroupGui.add(antPhaseDiff3.setup(" PhaseDiff 2.5λ SOUTH-NORTH (deg)", Const::getInstance().antPhaseDiff[3], 0, 360));
