...
void PhaseDiffGraphViewer::culcDiff(int _lifetime)
{
  ...
  std::cerr << LogUtil::getInstance().getIndentStr() + "•W€•Î·Alpha: " << standardDeviationAlpha << std::endl;
  std::cerr << LogUtil::getInstance().getIndentStr() + "•W€•Î·Beta: " << standardDeviationBeta << std::endl;
